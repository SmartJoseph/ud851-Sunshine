...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        if (mCursor.moveToPosition(position)) {
            ...
            double hi = mCursor.getDouble(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_MAX_TEMP));
            double lo = mCursor.getDouble(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_MIN_TEMP));

            String date = SunshineDateUtils.getFriendlyDateString(mContext, dateMillis, true);
            String description = SunshineWeatherUtils.getStringForWeatherCondition(mContext, weatherId);
            String temp = SunshineWeatherUtils.formatHighLows(mContext, hi, lo);
